...
export type BookingHoldAuditEvent = Readonly<{
  eventType: "BOOKING_HOLD_CREATED" | "BOOKING_HOLD_CANCELLED" | "BOOKING_HOLD_EXPIRED" | "BOOKING_HOLD_CONVERTED";
  holdId: UUID;
  actorIdentityId: UUID;
  tenantId: UUID;
  locationId: UUID;
...
export type BookingHoldOutboxEvent = Readonly<{
  eventType: "booking.hold.created.v1" | "booking.hold.cancelled.v1" | "booking.hold.expired.v1" | "booking.hold.converted.v1";
  holdId: UUID;
  tenantId: UUID;
  locationId: UUID;
  correlationId: string;
