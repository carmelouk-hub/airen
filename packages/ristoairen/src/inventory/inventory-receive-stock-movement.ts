...
function decimal6(value:string):bigint{const normalized=normalizePositiveDecimal(value,"decimal");const [whole,fraction]=normalized.split(".");return BigInt(whole)*1000000n+BigInt(fraction);}
